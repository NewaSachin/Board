...
// //     const updatedColumns = { ...columns };
// //     const columnItems = updatedColumns[editingTask.columnId].items.map((task) =>
// //       task.id === editingTask.id ? { ...task, content: editedContent } : task
// //     );
// //     updatedColumns[editingTask.columnId].items = columnItems;
// //     setColumns(updatedColumns);
// //     setEditingTask(null);
// //     setEditedContent("");
// //   };
...
// //   // Drag & Drop
// //   const handleDragStart = (columnId, item) => setDraggedItem({ columnId, item });
...
// //   const columnStyle = {
// //     todo: { header: "bg-gradient-to-b from-blue-400 to-blue-600" },
// //     inProgress: { header: "bg-gradient-to-b from-yellow-400 to-yellow-600" },
// //     done: { header: "bg-gradient-to-b from-green-400 to-green-600" },
// //   };
...
// //       {/* Overlay Kanban */}
// //       <div className="p-6 w-full min-h-screen bg-black/60 flex items-center justify-center">
// //         <div className="flex flex-col gap-4 w-full max-w-6xl">
// //           <h1 className="text-6xl font-bold mb-8 text-transparent bg-clip-text text-center bg-gradient-to-r from-purple-400 via-pink-500 to-red-500 cursor-pointer hover:scale-105">
// //             Kanban Board
// //           </h1>
...
// //               className="bg-zinc-700 text-white border-0 border-1 border-zinc-600"
// //             >
...
// //             <button
// //               onClick={addNewTask}
// //               className="px-6 bg-gradient-to-r from-yellow-500 to-amber-500 text-white font-medium hover:from-yellow-600 hover:to-amber-600 transition-all duration-200 cursor-pointer"
// //             >
// //               Add
// //             </button>
// //           </div>
...
// //               <div
// //                 key={columnId}
// //                 className="flex-shrink-0 w-80 bg-zinc-800 rounded-lg shadow-xl border-t-4 border-zinc-700"
...
// //                       <div
// //                         key={item.id}
// //                         className="p-4 mb-3 bg-zinc-700 text-white rounded-lg shadow-md cursor-pointer flex items-center justify-between transform transition-all duration-200 hover:scale-105 hover:shadow-lg"
// //                         draggable
...
//           <button
//             onClick={addNewTask}
//             className="px-6 py-2 bg-gradient-to-r from-yellow-500 to-amber-500 text-white font-medium hover:from-yellow-600 hover:to-amber-600 transition-all duration-200 rounded"
//           >
//             Add
//           </button>
//         </div>
...
//                     <div
//                       key={item.id}
//                       className="p-3 sm:p-4 mb-3 bg-zinc-700 text-white rounded-lg shadow-md cursor-pointer flex items-center justify-between transform transition-all duration-200 hover:scale-105 hover:shadow-lg"
//                       draggable
//                       onDragStart={() => handleDragStart(columnId, item)}
//                     >
...
//                         <button
//                           onClick={() => startEditing(columnId, item)}
//                           className="text-zinc-400 hover:text-blue-400 transition-colors duration-200 text-sm sm:text-base"
//                         >
//                           ✏️
//                         </button>
//                         <button
//                           onClick={() => removeTask(columnId, item.id)}
//                           className="text-zinc-400 hover:text-red-400 transition-colors duration-200 text-sm sm:text-base"
//                         >
//                           ❌
//                         </button>
//                       </div>
